...
export default function LikeDislike() {
    ...
    return (
        <div>
          <button onClick={like} className="bg-gray-100 px-8 ml-10 rounded-l-full">{nb_like}<img className="w-6 py-2" src={likeImg} /></button>
          <button onClick={dislike} className="bg-gray-100 px-8 rounded-r-full">{nb_dislike}<img className="w-6 py-2" src={dislikeImg} /></button>
