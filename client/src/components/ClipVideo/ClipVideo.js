    ...
    <div className="pl-40 mt-8">
      ...
      />
        ...
        <div className="flex">
            ...
            <button className="bg-gray-200 px-8 ml-10 rounded-l-full"><img className="w-8" src={like}/></button>
            <button className="bg-gray-200 px-8 rounded-r-full"><img className="w-8" src={dislike}/></button>
            <button className="bg-gray-200 px-8 ml-10 rounded-full"><img className="w-8" src={share}/></button>
        </div>
    
        <div className="flex flex-col items-center justify-center w-700 " >
    <p>1 735 380 vues  1 sept. 2023 #sifu #nodamage</p>
    <p>World's First Sifu run with these conditions met:
- Master Difficulty
- No Damage
- New Game
