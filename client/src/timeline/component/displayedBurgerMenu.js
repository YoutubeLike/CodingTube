...
const DisplayedBurgerMenu = () => {
  ...
  var iconsMenu = [
    ...
    <Link to="/video-games" className="flex items-center">
      ...
      >
        ...
        ></path>
        <circle cx="292" cy="224" r="20" fill="#0B1215"></circle>
        <path
          fill="#0B1215"
          d="M336 288a20 20 0 1 1 20-19.95A20 20 0 0 1 336 288"
        ></path>
        <circle cx="336" cy="180" r="20" fill="#0B1215"></circle>
        <circle cx="380" cy="224" r="20" fill="#0B1215"></circle>
        <path
          fill="none"
          stroke="#0B1215"
          stroke-linecap="round"
  ...
  for (var i = 0; i < 3; i++) {
    ...
    divContent1.push(
      <div className="hover:bg-gray-100 min-w-[100%] flex pl-4 mt-2">
        {divContent}
      </div>
    );
  }
  ...
  return (
    <>
      <div
        className="HAMBURGER-ICON space-y-2 rounded-full p-1 hover:bg-slate-300"
      ...
      <div>
        <div className={isNavOpen ? "showMenuNav" : "hideMenuNav"}>
          ...
          {divContent1}
          <div className="border-t-[1px] bg-[#e5e5e5] min-w-[100%] mt-2"></div>
          ...
          {divContent2}
          <div className="border-t-[1px] bg-[#e5e5e5] min-w-[100%] mt-2"></div>
          <div className="hover:bg-gray-100 min-w-[100%] flex items-center pl-4  mt-1">
            Explore
          </div>
          {divContent3}
          <div className="border-t-[1px] bg-[#e5e5e5] min-w-[100%] mt-2"></div>
